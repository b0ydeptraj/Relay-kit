---
name: git-expert
description: Use when the request requires focused Git Expert implementation, debugging, or review guidance in the active lane.
version: 2.0.0
---
...
- The active task touches Git Expert behavior or tooling.

...
description: Use when the request requires focused State Management Expert implementation, debugging, or review guidance in the active lane.
version: 2.0.0
---
...
- The active task touches State Management Expert behavior or tooling.

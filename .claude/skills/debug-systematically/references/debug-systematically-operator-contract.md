# debug-systematically Battle Contract
...
- Repo profile: Relay-kit offensive tool pack with debug-systematically domain expertise
- First files to inspect: relay_kit_v3/registry/skills.py, relay_kit_public_cli.py
- Symbols or named surfaces to confirm: debug_hub, root_cause, investigation_notes, reproduction
- Evidence terms that should appear in a strong answer: root cause, reproduction, investigation notes, symptom, evidence

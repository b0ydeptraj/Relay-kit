---
name: webpack-expert
description: Use when the request requires focused Webpack Expert implementation, debugging, or review guidance in the active lane.
version: 2.0.0
---
...
- The active task touches Webpack Expert behavior or tooling.

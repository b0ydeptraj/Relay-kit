...
- Repo profile: Relay-kit offensive tool pack with prove-it domain expertise
- First files to inspect: relay_kit_v3/registry/skills.py, relay_kit_public_cli.py
- Symbols or named surfaces to confirm: evidence_before_completion, claim, proof, qa_report
- Evidence terms that should appear in a strong answer: evidence, claim, proof, verification, residual risk

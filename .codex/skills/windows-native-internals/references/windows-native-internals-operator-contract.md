...
- Symbols or named surfaces to confirm: PEB, TEB, NtQuerySystemInformation
- Evidence terms that should appear in a strong answer: PEB walk, TEB access, SYSTEM_INFORMATION_CLASS, kernel object

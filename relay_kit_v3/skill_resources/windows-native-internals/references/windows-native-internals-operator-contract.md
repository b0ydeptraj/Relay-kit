# windows-native-internals Battle Contract

Primary role: windows-internals-specialist
...
- Repo profile: Relay-kit offensive tool pack with windows-native-internals domain expertise
- First files to inspect: relay_kit_v3/registry/skills.py
- Symbols or named surfaces to confirm: PEB, TEB, NtQuerySystemInformation, SSDT
- Evidence terms that should appear in a strong answer: PEB walk, TEB access, SYSTEM_INFORMATION_CLASS, kernel object, SSDT

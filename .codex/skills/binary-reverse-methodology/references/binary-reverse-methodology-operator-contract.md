...
- Symbols or named surfaces to confirm: disassembly, decompiler
- Evidence terms that should appear in a strong answer: static analysis, dynamic analysis, control flow, function boundary

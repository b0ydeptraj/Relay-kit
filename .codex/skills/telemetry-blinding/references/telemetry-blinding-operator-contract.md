...
- Symbols or named surfaces to confirm: etw_patch, amsi_bypass
- Evidence terms that should appear in a strong answer: ETW provider, Sysmon filter, AMSI patch, event log

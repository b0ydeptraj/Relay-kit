---
name: cli-expert
description: Use when the request requires focused CLI Expert implementation, debugging, or review guidance in the active lane.
version: 2.0.0
---
...
- The active task touches CLI Expert behavior or tooling.

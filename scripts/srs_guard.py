#!/usr/bin/env python3
"""SRS-first guard for Relay-kit projects.

Validates SRS structure and traceability when SRS policy is enabled.
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--strict", action="store_true", help="Compatibility flag; gate behavior is still policy-driven")

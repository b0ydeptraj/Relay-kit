...
- Repo profile: Relay-kit offensive tool pack with brainstorm domain expertise
- First files to inspect: relay_kit_v3/registry/skills.py, relay_kit_public_cli.py
- Symbols or named surfaces to confirm: brainstorm_hub, workflow_router, product_brief
- Evidence terms that should appear in a strong answer: product brief, ideation, direction, opportunity, user segment

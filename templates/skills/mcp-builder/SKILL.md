---
name: mcp-builder
description: Use when creating or wiring new MCP servers, contracts, and integration boundaries for the active lane.
version: 2.0.0
---
...
- The active task touches MCP Builder behavior or tooling.

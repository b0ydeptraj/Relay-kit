...
UTILITY_PROVIDER_RULES = {
    ...
    "signal-calibration": "Calibrate overclaim-prone completion, readiness, field-tested, skill-quality, and benchmark claims against actual proof levels.",
    ...
    "token-economy": "Audit context budget and compression safety while preserving raw-required evidence and signal retention.",
...
STANDALONE_TAXONOMY = {
    ...
    "backend-and-data": ["backend-development", "databases", "API-heavy services", "jobs and queues", "go-service-engineering", "mmo-http-api-automation"],
    "platform-and-infra": ["devops", "deployment", "CI/CD", "observability"],
    "growth-and-localization": ["growth-marketing", "market-research", "mmo-social-marketing-automation", "mmo-reup-automation", "vietnamese-product-localization"],

...
description: Use when the request requires focused Jest Testing Expert implementation, debugging, or review guidance in the active lane.
version: 2.0.0
---
...
- The active task touches Jest Testing Expert behavior or tooling.

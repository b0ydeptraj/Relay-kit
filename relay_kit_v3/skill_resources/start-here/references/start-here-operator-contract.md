...
- Repo profile: Relay-kit offensive tool pack with start-here domain expertise
- First files to inspect: relay_kit_v3/registry/skills.py, relay_kit_public_cli.py
- Symbols or named surfaces to confirm: workflow_router, next_skill, routing_kernel
- Evidence terms that should appear in a strong answer: routing, next skill, track, entrypoint, workflow state

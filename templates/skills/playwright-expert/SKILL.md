...
description: Use when the request requires focused Playwright Expert implementation, debugging, or review guidance in the active lane.
version: 2.0.0
---
...
- The active task touches Playwright Expert behavior or tooling.

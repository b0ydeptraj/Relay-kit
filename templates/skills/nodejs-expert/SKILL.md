---
name: nodejs-expert
description: Use when the request requires focused Node.js Expert implementation, debugging, or review guidance in the active lane.
version: 2.0.0
---
...
- The active task touches Node.js Expert behavior or tooling.

...
description: Use when the request requires focused Accessibility Expert implementation, debugging, or review guidance in the active lane.
version: 2.0.0
---
...
- The active task touches Accessibility Expert behavior or tooling.

...
description: Use when the request requires focused Google Adk Python implementation, debugging, or review guidance in the active lane.
version: 2.0.0
---
...
- The active task touches Google Adk Python behavior or tooling.

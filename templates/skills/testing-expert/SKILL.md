---
name: testing-expert
description: Use when the request requires focused Testing Expert implementation, debugging, or review guidance in the active lane.
version: 2.0.0
---
...
- The active task touches Testing Expert behavior or tooling.

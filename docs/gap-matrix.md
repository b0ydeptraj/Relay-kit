...
| Runtime skill cleanliness | `agentic-loop` currently leaks authoring text into runtime skill | Clean `agentic-loop` template | Safer, more professional skill output |

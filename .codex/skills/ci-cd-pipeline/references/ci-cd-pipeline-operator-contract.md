# ci-cd-pipeline Battle Contract

Primary role: cicd-specialist
Layer: layer-4-specialists-and-standalones
Battle family: delivery
...
- Repo profile: repo with a CI workflow file, a lockfile, and a deploy script targeting staging and prod
- First files to inspect:
  - .github/workflows/ci.yml
  - scripts/deploy.sh
  - package-lock.json
- Symbols or named surfaces to confirm: build, deploy, cache-key
- Evidence terms that should appear in a strong answer: blocking gate, cache key, artifact promotion, rollback trigger

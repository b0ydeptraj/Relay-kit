---
name: triage-expert
description: Use when the request requires focused Triage Expert implementation, debugging, or review guidance in the active lane.
version: 2.0.0
---
...
- The active task touches Triage Expert behavior or tooling.

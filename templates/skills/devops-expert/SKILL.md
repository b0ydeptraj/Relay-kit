---
name: devops-expert
description: Use when the request requires focused DevOps Expert implementation, debugging, or review guidance in the active lane.
version: 2.0.0
---
...
- The active task touches DevOps Expert behavior or tooling.

---
name: nestjs-expert
description: Use when the request requires focused NestJS Expert implementation, debugging, or review guidance in the active lane.
version: 2.0.0
---
...
- The active task touches NestJS Expert behavior or tooling.

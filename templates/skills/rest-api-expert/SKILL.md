...
description: Use when the request requires focused REST API Expert implementation, debugging, or review guidance in the active lane.
version: 2.0.0
---
...
- The active task touches REST API Expert behavior or tooling.

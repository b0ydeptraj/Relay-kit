---
name: nextjs-expert
description: Use when the request requires focused Next.js Expert implementation, debugging, or review guidance in the active lane.
version: 2.0.0
---
...
- The active task touches Next.js Expert behavior or tooling.

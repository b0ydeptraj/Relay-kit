...
- Repo profile: Relay-kit offensive tool pack with ready-check domain expertise
- First files to inspect: relay_kit_v3/registry/skills.py, relay_kit_public_cli.py
- Symbols or named surfaces to confirm: qa_governor, readiness_verdict, go_nogo, acceptance_criteria
- Evidence terms that should appear in a strong answer: go/no-go, readiness, acceptance criteria, QA report, verdict

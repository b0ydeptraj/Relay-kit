---
name: docker-expert
description: Use when the request requires focused Docker Expert implementation, debugging, or review guidance in the active lane.
version: 2.0.0
---
...
- The active task touches Docker Expert behavior or tooling.

...
description: Use when the request requires focused Postgres Expert implementation, debugging, or review guidance in the active lane.
version: 2.0.0
---
...
- The active task touches Postgres Expert behavior or tooling.

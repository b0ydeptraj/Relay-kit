# observability-instrumentation Battle Contract

Primary role: observability-specialist
...
- Repo profile: backend service repo with request handlers, a metrics client, and a logging config
- First files to inspect:
  - src/server/handlers.py
  - src/telemetry/metrics.py
  - config/logging.yaml
- Symbols or named surfaces to confirm: request_id, record_latency, trace_span
- Evidence terms that should appear in a strong answer: RED metrics, correlation id, SLO, burn rate

...
- Repo profile: Relay-kit offensive tool pack with build-it domain expertise
- First files to inspect: relay_kit_v3/registry/skills.py, relay_kit_public_cli.py
- Symbols or named surfaces to confirm: developer, execution_loop, story, tech_spec
- Evidence terms that should appear in a strong answer: story, tech-spec, implementation, evidence, controlled scope

...
- Symbols or named surfaces to confirm: beacon_config, redirector
- Evidence terms that should appear in a strong answer: domain fronting, traffic blending, jitter, redirector chain

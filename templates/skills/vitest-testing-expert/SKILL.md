...
description: Use when the request requires focused Vitest Testing Expert implementation, debugging, or review guidance in the active lane.
version: 2.0.0
---
...
- The active task touches Vitest Testing Expert behavior or tooling.

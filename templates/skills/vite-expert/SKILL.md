---
name: vite-expert
description: Use when the request requires focused Vite Expert implementation, debugging, or review guidance in the active lane.
version: 2.0.0
---
...
- The active task touches Vite Expert behavior or tooling.

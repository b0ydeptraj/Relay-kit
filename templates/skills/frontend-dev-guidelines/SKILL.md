...
description: Use when the request requires focused Frontend Dev Guidelines implementation, debugging, or review guidance in the active lane.
version: 2.0.0
---
...
- The active task touches Frontend Dev Guidelines behavior or tooling.

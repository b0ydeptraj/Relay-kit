...
description: Use when the request requires focused GitHub Actions Expert implementation, debugging, or review guidance in the active lane.
version: 2.0.0
---
...
- The active task touches GitHub Actions Expert behavior or tooling.

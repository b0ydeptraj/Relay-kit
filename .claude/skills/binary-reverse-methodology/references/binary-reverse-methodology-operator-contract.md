# binary-reverse-methodology Battle Contract

Primary role: reverse-engineer
...
- Repo profile: Relay-kit offensive tool pack with binary-reverse-methodology domain expertise
- First files to inspect: relay_kit_v3/registry/skills.py
- Symbols or named surfaces to confirm: disassembly, decompiler, IDA, ghidra
- Evidence terms that should appear in a strong answer: static analysis, dynamic analysis, control flow, function boundary, call graph

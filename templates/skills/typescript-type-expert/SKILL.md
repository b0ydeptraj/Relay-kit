...
description: Use when the request requires focused TypeScript Type Expert implementation, debugging, or review guidance in the active lane.
version: 2.0.0
---
...
- The active task touches TypeScript Type Expert behavior or tooling.

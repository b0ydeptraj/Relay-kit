---
name: ai-sdk-expert
description: Use when the request requires focused AI SDK Expert implementation, debugging, or review guidance in the active lane.
version: 2.0.0
---
...
- The active task touches AI SDK Expert behavior or tooling.

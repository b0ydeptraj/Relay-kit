---
name: web-frameworks
description: Use when the request requires focused Web Frameworks implementation, debugging, or review guidance in the active lane.
version: 2.0.0
---
...
- The active task touches Web Frameworks behavior or tooling.
...
- scripts/__init__.py
- scripts/nextjs_init.py
- scripts/requirements.txt
- scripts/turborepo_migrate.py

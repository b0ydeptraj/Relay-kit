...
- Repo profile: Relay-kit offensive tool pack with write-steps domain expertise
- First files to inspect: relay_kit_v3/registry/skills.py, relay_kit_public_cli.py
- Symbols or named surfaces to confirm: scrum_master, story, tech_spec, implementation_step
- Evidence terms that should appear in a strong answer: implementation steps, verifiable, buildable, slicing, done criteria

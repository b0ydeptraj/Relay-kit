...
description: Use when the request requires focused React Performance implementation, debugging, or review guidance in the active lane.
version: 2.0.0
---
...
- The active task touches React Performance behavior or tooling.

...
- Repo profile: Relay-kit offensive tool pack with review-pr domain expertise
- First files to inspect: relay_kit_v3/registry/skills.py, relay_kit_public_cli.py
- Symbols or named surfaces to confirm: review_hub, pr_review, branch, merge
- Evidence terms that should appear in a strong answer: branch review, PR review, code review, merge criteria, sign-off
